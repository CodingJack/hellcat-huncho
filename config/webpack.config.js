...
module.exports = env => {
  ...
  return {
    ...
    output: {
      path: resolve( 'dist' ),
      filename: pathData => {
        return pathData.chunk.name === 'main' ? 'timecut.min.js' : 'vendors/timecut-vendors.min.js';
      },
      chunkFilename: pathData => {
        ...
        return pathData.chunk.chunkReason ? `vendors/timecut-${ fileName }.min.js` : `components/timecut_[id].min.js`;
      },
      publicPath: 'js/',
    },
    resolve: {
